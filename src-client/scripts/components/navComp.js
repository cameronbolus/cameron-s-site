...
export const NavComponent = React.createClass({
	...
	render: function(){
        ...
        <div className="nav-options">
          ...
          <div className="resume-link hover-color spaced-out"><a className="resume-link hover-color spaced-out" href="../images/CBDevResume.pdf" target="_blank">Resume</a></div>
